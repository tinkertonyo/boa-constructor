...
class FindReplaceDlg(wxDialog):
    ...
    def _init_ctrls(self, prnt):
        wxDialog.__init__(self, id = wxID_FINDREPLACEDLG, name = 'FindReplaceDlg', parent = prnt, pos = wxPoint(415, 288), size = wxSize(372, 234), style = wxDEFAULT_DIALOG_STYLE, title = 'Find/Replace Dialog')
        self._init_utils()
        ...
        self.findTxt = wxComboBox(id = wxID_FINDREPLACEDLGFINDTXT, name = 'findTxt', parent = self, pos = wxPoint(80, 4), size = wxSize(276, 21), style = wxTE_PROCESS_ENTER, value = '')

        self.replaceTxt = wxComboBox(id = wxID_FINDREPLACEDLGREPLACETXT, name = 'replaceTxt', parent = self, pos = wxPoint(80, 28), size = wxSize(276, 21), style = wxTE_PROCESS_ENTER, value = '')
