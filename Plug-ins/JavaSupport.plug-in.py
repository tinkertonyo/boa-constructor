...
Preferences.IS.registerImage('Images/Modules/JavaModule.png', getJavaModuleData())
Preferences.IS.registerImage('Images/Palette/JavaPalette.png', getJavaPaletteData())
